...
public class Dao<T> {
	...
	public Dao(Session session) {
		...
		this.classePersistencia = (Class<T>) ((ParameterizedType) getClass()
	...
	protected Criterion getParametroBusca(String nomeDoCampo,
			String textoDaBusca) {
		return Restrictions
				.ilike(nomeDoCampo, textoDaBusca, MatchMode.ANYWHERE);
	}
